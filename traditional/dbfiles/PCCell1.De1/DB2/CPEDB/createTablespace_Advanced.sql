...
CREATE SCHEMA ICNSA AUTHORIZATION db2admin;
-- Comments on the above statement. This is for sync. If the user who
-- creating the schema is the same as the one specified in db2admin
...
GRANT USE OF TABLESPACE TOSSA_DATA_TS TO user db2admin;
GRANT USE OF TABLESPACE TOSSA_IDX_TS TO user db2admin;
GRANT USE OF TABLESPACE TOSSA_LOB_TS TO user db2admin;
GRANT USE OF TABLESPACE TOSSA_TEMP_TS TO user db2admin;
...
GRANT USE OF TABLESPACE DOSSA_DATA_TS TO user db2admin;
GRANT USE OF TABLESPACE DOSSA_IDX_TS TO user db2admin;
GRANT USE OF TABLESPACE DOSSA_LOB_TS TO user db2admin;
GRANT USE OF TABLESPACE DOSSA_TEMP_TS TO user db2admin;
